...
const translations = {
  ru: {
    ...
    'forgotPassword.subtitleVerify': 'Подтвердите личность через Telegram',
    'forgotPassword.subtitleSetPassword': 'Придумайте новый пароль',
    'forgotPassword.subtitleDone': 'Пароль изменён',
    'forgotPassword.hint': 'Нажмите кнопку ниже, чтобы войти через Telegram и подтвердить свой аккаунт.',
    'forgotPassword.verifiedAs': 'Вы вошли как',
    'forgotPassword.newPassword': 'Новый пароль',
    'forgotPassword.confirmPassword': 'Повторите пароль',
    'forgotPassword.submit': 'Сохранить пароль',
    'forgotPassword.submitting': 'Сохраняем…',
    'forgotPassword.successMessage': 'Ваш пароль успешно изменён. Теперь вы можете войти.',
    'forgotPassword.goLogin': 'Войти',
    'forgotPassword.backToLogin': 'Вернуться к входу',
    'forgotPassword.passwordMismatch': 'Пароли не совпадают',
    'forgotPassword.noAccount': 'Аккаунт с этим Telegram не найден',
    'forgotPassword.expired': 'Время подтверждения истекло, попробуйте снова',

    'register.title': 'Регистрация',
    'register.subtitle': 'Создайте аккаунт за минуту.',
    'register.name': 'Имя',
    'register.username': 'Имя пользователя',
    'register.usernameHint': 'Латиница, цифры, точка, дефис',
  ...
  kk: {
    ...
    'forgotPassword.subtitleVerify': 'Telegram арқылы жеке басыңызды растаңыз',
    'forgotPassword.subtitleSetPassword': 'Жаңа құпия сөз ойлап табыңыз',
    'forgotPassword.subtitleDone': 'Құпия сөз өзгертілді',
    'forgotPassword.hint': 'Telegram арқылы кіру үшін төмендегі түймені басыңыз.',
    'forgotPassword.verifiedAs': 'Сіз кірдіңіз',
    'forgotPassword.newPassword': 'Жаңа құпия сөз',
    'forgotPassword.confirmPassword': 'Құпия сөзді қайталаңыз',
    'forgotPassword.submit': 'Сақтау',
    'forgotPassword.submitting': 'Сақталуда…',
    'forgotPassword.successMessage': 'Құпия сөзіңіз сәтті өзгертілді. Енді кіре аласыз.',
    'forgotPassword.goLogin': 'Кіру',
    'forgotPassword.backToLogin': 'Кіру бетіне оралу',
    'forgotPassword.passwordMismatch': 'Құпия сөздер сәйкес келмейді',
    'forgotPassword.noAccount': 'Бұл Telegram-мен байланысқан аккаунт табылмады',
    'forgotPassword.expired': 'Растау уақыты өтті, қайталап көріңіз',

    'register.title': 'Тіркелу',
    'register.subtitle': 'Бір минутта аккаунт жасаңыз.',
    'register.name': 'Аты',
    'register.username': 'Пайдаланушы аты',
    'register.usernameHint': 'Латын, сандар, нүкте, сызықша',
  ...
  en: {
    ...
    'forgotPassword.subtitleVerify': 'Verify your identity via Telegram',
    'forgotPassword.subtitleSetPassword': 'Choose a new password',
    'forgotPassword.subtitleDone': 'Password changed',
    'forgotPassword.hint': 'Press the button below to sign in with Telegram and verify your account.',
    'forgotPassword.verifiedAs': 'Signed in as',
    'forgotPassword.newPassword': 'New password',
    'forgotPassword.confirmPassword': 'Confirm password',
    'forgotPassword.submit': 'Save password',
    'forgotPassword.submitting': 'Saving…',
    'forgotPassword.successMessage': 'Your password has been changed. You can now sign in.',
    'forgotPassword.goLogin': 'Sign In',
    'forgotPassword.backToLogin': 'Back to sign in',
    'forgotPassword.passwordMismatch': 'Passwords do not match',
    'forgotPassword.noAccount': 'No account linked to this Telegram',
    'forgotPassword.expired': 'Verification expired, please try again',

    'register.title': 'Sign Up',
    'register.subtitle': 'Create an account in a minute.',
    'register.name': 'Name',
    'register.username': 'Username',
    'register.usernameHint': 'Letters, numbers, dot, dash',
